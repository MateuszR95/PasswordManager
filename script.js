  ...
  function checkPassword() {
      ...
      if (!isLengthValid) passwordError.innerHTML += 'Hasło powinno mieć co najmniej 8 znaków.<br>';
      ...
      if (!isPasswordMatch) confirmPasswordError.innerHTML = 'Hasło i potwierdzenie hasła nie są identyczne.<br>';
  }
